...
{% include image.html url="jmeter-distributed-testing-structure.png" desc="Jmeter分布式测试模型" %}
...
{% include image.html url="jmeter-distributed-test.png" desc="example test architecture" %}
...
Jmeter 是一款很赞的软件，thanks apache open source ！
