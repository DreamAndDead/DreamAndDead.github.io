...
{% include image.html url="kd-tree/kd-tree-intro.png" desc="2 dimension kd tree" %}
...
{% include image.html url="kd-tree/kd-tree-insert.png" desc="2 dimension kd tree insert" %}

我们可以用 insert 方法来构建 KD Tree，只需要将所有数据顺序插入即可。

{% include gist-it.html path="DreamAndDead/kd-tree-example/blob/f05161dd86486fe673e6615a4477e630cf8b80c4/kdtree.py" start=116 end=139 %}
...
{% include gist-it.html path="DreamAndDead/kd-tree-example/blob/f05161dd86486fe673e6615a4477e630cf8b80c4/kdtree.py" start=140 end=159 %}

## find_min

find_min 的含义是，在 KD Tree 树中查找某一个维度值最小的节点。

{% include image.html url="kd-tree/kd-tree-example.png" desc="2 dimension kd tree" %}
...
{% include image.html url="kd-tree/find_min_x.png" desc="find min node in x dimension" %}
...
{% include gist-it.html path="DreamAndDead/kd-tree-example/blob/f05161dd86486fe673e6615a4477e630cf8b80c4/kdtree.py" start=160 end=187 %}
...
{% include image.html url="kd-tree/delete-with-two-subtrees.png" desc="delete node A in dimension cd" %}
...
{% include image.html url="kd-tree/delete-without-right-subtree.png" desc="delete node A without right subtree" %}
...
{% include gist-it.html path="DreamAndDead/kd-tree-example/blob/f05161dd86486fe673e6615a4477e630cf8b80c4/kdtree.py" start=188 end=216 %}
...
{% include image.html url="kd-tree/kd-tree-bounding.png" desc="kd tree bounding box" %}
...
{% include image.html url="kd-tree/bounding-box-optimization.png" desc="bounding box optimization" %}
...
{% include gist-it.html path="DreamAndDead/kd-tree-example/blob/f05161dd86486fe673e6615a4477e630cf8b80c4/kdtree.py" start=222 end=260 %}
...
{% include gist-it.html path="DreamAndDead/kd-tree-example/blob/f05161dd86486fe673e6615a4477e630cf8b80c4/kdtree.py" start=261 end=297 %}
